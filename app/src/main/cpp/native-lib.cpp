...
JNIEXPORT jobject JNICALL Java_net_monatis_apps_ocvstarter_MainActivity_getScannedBitmap
  (JNIEnv *, jobject, jobject, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat, jfloat);


JNIEXPORT jfloatArray JNICALL Java_net_monatis_apps_ocvstarter_MainActivity_getPoints
(JNIEnv *, jobject, jobject);

JNIEXPORT jobject JNICALL Java_net_monatis_apps_ocvstarter_MainActivity_getBWBitmap
(JNIEnv *, jobject, jobject);

JNIEXPORT jobject JNICALL Java_net_monatis_apps_ocvstarter_MainActivity_getMagicColorBitmap
(JNIEnv *, jobject, jobject);

JNIEXPORT jobject JNICALL Java_net_monatis_apps_ocvstarter_MainActivity_getGrayBitmap
(JNIEnv *, jobject, jobject);
